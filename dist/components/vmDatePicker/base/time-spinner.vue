    ...
    <div 
      ...
      <ul :class="[prefixCls + '-ul']">
        <li 
          ...
          @click="handleClick('hours', item)">{{ formatTime(item.text) }}</li>
      </ul>
    </div>
    <div 
      ref="minutes" 
      ...
      <ul :class="[prefixCls + '-ul']">
        <li 
          ...
          v-show="!item.hide" 
          :class="getCellCls(item)" 
          @click="handleClick('minutes', item)">{{ formatTime(item.text) }}</li>
      </ul>
    </div>
    <div 
      v-show="showSeconds" 
      ...
      <ul :class="[prefixCls + '-ul']">
        <li 
          ...
          v-show="!item.hide" 
          :class="getCellCls(item)" 
          @click="handleClick('seconds', item)">{{ formatTime(item.text) }}</li>
      </ul>
    </div>
  </div>
</template>
<script>
    ...
    const prefixCls = 'vm-timepicker-cells';

...
<template lang="html">
  <div class="con-select-example">
    ...
    <vm-select
      ...
      v-model="select3"
      >
      <vm-select-item :key="index" :disabled="index==2" :value="item.value" :text="item.text" v-for="item,index in options3" />
    </vm-select>
    <vm-select
      class="selectExample"
      label="Figuras"
...
<template lang="html">
  <div class="con-select-example">
    ...
    <vm-select
      ...
      v-model="select3"
      >
      <vm-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in options3" />
    </vm-select>
  </div>
</template>
  ...
  <div class="con-select-example">
    <vm-select
     :success="true"
      ...
      v-model="select1"
      >
      <vm-select-item :key="index" :value="item.value" :text="item.text" v-for="item,index in exampleOptions" />
    </vm-select>
       <vm-select
      :danger="true"
...
<template lang="html">
  <div class="con-select-example">
    <vm-select
      ...
      v-model="select1"
      >
      <vm-select-item :is-selected.sync="item.isSelected" :key="index" :value="item.value" :text="item.isSelected?item.selectedText:item.label" v-for="item,index in options1" />
    </vm-select>
  </div>
</template>
...
You can group elements with the sub component `vm-select-group`
  ...
  <div class="con-select-example">
    <vm-select
        ...
        <div :key="index" v-for="item,index in options1">
          <vm-select-group :title="item.title" v-if="item.group">
            <vm-select-item :key="index" :value="item.value" :text="item.text" v-for="item,index in item.group"/>
          </vm-select-group>
        </div>
    </vm-select>
    <vm-select

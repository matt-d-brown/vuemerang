...
You can upload files to the server with the `vm-upload` component, the requested parameter is `action` which is the URL of the server
...
<template lang="html">
  <div class="centerx">
    <vm-upload action="https://jsonplaceholder.typicode.com/posts/" @on-success="successUpload" />
  </div>
</template>
...
export default {
  methods:{
    successUpload(){
      this.$vm.notify({color:'success',title:'Upload Success',text:'Lorem ipsum dolor sit amet, consectetur'})
    }
  }
}
</script>
...
<template lang="html">
  <div class="centerx">
    <vm-upload multiple text="Upload Multiple" action="https://jsonplaceholder.typicode.com/posts/" @on-success="successUpload" />
  </div>
</template>
...
<template lang="html">
  <div class="centerx">
    <vm-upload automatic action="https://jsonplaceholder.typicode.com/posts/" @on-success="successUpload" />
  </div>
</template>

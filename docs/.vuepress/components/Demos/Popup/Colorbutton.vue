<template lang="html">
  <div class="centerx">
    ...
    <vm-button :color="colorx2" @click="popupActivo6=true" color="dark" type="border">Open color button popup</vm-button>

    <vm-popup :close-button-color="colorx2" title="Color Button" :active="popupActivo6" @cancel="popupActivo6=false">
      <p>

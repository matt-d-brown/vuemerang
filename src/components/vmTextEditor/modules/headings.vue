<template>
  <div>
    <button 
      type="button" 
      @click="insertHeading">H1</button>
    <button 
      type="button" 
      @click="insertHeading">H2</button>
    <button 
      type="button" 
      @click="insertHeading">H3</button>
    <button 
      type="button" 
      @click="insertHeading">H4</button>
    <button 
      type="button" 
      @click="insertHeading">H5</button>
    <button 
      type="button" 
      @click="insertHeading">H6</button>
  </div>
</template>

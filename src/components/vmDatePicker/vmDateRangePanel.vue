            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                    <span
                        ...
                        @click="prevYear('left')"><vm-icon :icon-pack="iconPack" :icon="prevIcon"></vm-icon></span>
                    <span
                        v-if="leftPickerTable === 'date-table'"
                        :class="iconBtnCls('prev')"
                        @click="prevMonth('left')"
                        v-show="currentView === 'date'"><vm-icon :icon-pack="iconPack" :icon="prevIcon"></vm-icon></span>
                    <date-panel-label
                    ...
                    <span
                        ...
                        @click="nextYear('left')"><vm-icon :icon-pack="iconPack" :icon="nextIcon"></vm-icon></span>
                    <span
                        v-if="splitPanels && leftPickerTable === 'date-table'"
                        :class="iconBtnCls('next')"
                        @click="nextMonth('left')"
                        v-show="currentView === 'date'"><vm-icon :icon-pack="iconPack" :icon="nextIcon"></vm-icon></span>
                </div>
                <component
                    :is="leftPickerTable"
                    ref="leftYearTable"
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                    <span
                        ...
                        :class="iconBtnCls('prev', '-double')"
                        @click="prevYear('right')"><vm-icon :icon-pack="iconPack" :icon="prevIcon"></vm-icon></span>
                    <span
                        v-if="splitPanels && rightPickerTable === 'date-table'"
                        :class="iconBtnCls('prev')"
                    ...
                    <span
                        :class="iconBtnCls('next', '-double')"
                        @click="nextYear('right')"><vm-icon :icon-pack="iconPack" :icon="nextIcon"></vm-icon></span>
                    <span

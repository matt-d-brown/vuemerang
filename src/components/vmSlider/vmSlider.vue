  ...
  <div
    ...
    <button
      ...
      <span
        ...
        class="vm-slider-line-one"></span>
      <span class="vm-slider-line-two"></span>

      <span
        :class="{'run-effect':effect}"
        :style="styleEfect"
        class="vm-slider-line-efect"></span>
    ...
    <button
      ...
      :style="styleCircle"
      class="vm-circle-slider vm-circles-slider vm-slider--circles vm-slider--circle"
      @touchstart="activeFocus($event),actived = true"
      @mousedown="activeFocus($event),actived = true">
      <span
        :style="styleText"
        class="text-circle-slider vm-slider--circle-text">
        {{ valueCircle1 }}
        <span v-if="textFixed">
          {{ textFixed }}
        </span>
    ...
    <button
      ...
      class="vm-circle-slider-two vm-circles-slider vm-slider--circles vm-slider--circle-two"
